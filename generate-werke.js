...
<section class="werk-hero">
  ...
  <div class="werk-info">
    ...
    <div class="werk-price-block">
      ...
      <div class="werk-price-note">${isSold ? 'Dieses Werk ist verkauft. Auftragsarbeit möglich.' : (werk.preis === null ? 'Preis nach Anfrage. Versand deutschlandweit.' : 'Inkl. MwSt. · Versand deutschlandweit')}</div>
    </div>
